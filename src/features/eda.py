...
print( titanic_train_data[["Age_new","Survived"]].groupby(["Age_new"], as_index = False).mean() )#>> depending on the Age category
...
print(titanic_train_data[["Fare_new","Survived"]].groupby(["Fare_new"], as_index = False).mean() )#>> depending on the Fare category
print(titanic_train_data[["Sex","Survived"]].groupby(["Sex"], as_index = False).mean() )#>> depending on the Fare category

...
print("----------------------")
print(titanic_train_data[['title','Survived']].groupby(['title'], as_index = False).mean())
...
print(titanic_train_data[["category_fare","Survived"]].groupby(["category_fare"], as_index = False).mean() )
...
print( titanic_train_data[["category_age","Survived"]].groupby(["category_age"], as_index = False).mean() )
...
print( titanic_train_data[['Age_new',"Survived"]].groupby(['Age_new'], as_index = False).mean() )



# Embarked-Survived
print( titanic_train_data[["Embarked","Survived"]].groupby(["Embarked"], as_index = False).mean() )
# Pclass-Survived
print( titanic_train_data[["Pclass","Survived"]].groupby(["Pclass"], as_index = False).mean() )
